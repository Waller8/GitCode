 ...
 * 行为: 画(坦克炮口应随向转动),移动
 */
public class MyTank extends Tank implements Moveable,Blockable{
    private int blood = 5;  //坦克血量
    private int speed = 32; //坦克每次移动的距离
    public Direction direction = Direction.UP;//坦克方向
    public Direction baddir;   //记录坦克不能移动的方向.
    //定义四个坦克,炮口朝向不同.
    private String path1 = "TankWar/res/img/tank_u.gif";
    private String path2 = "TankWar/res/img/tank_d.gif";
    private String path3 = "TankWar/res/img/tank_l.gif";
    private String path4 = "TankWar/res/img/tank_r.gif";
    ...
    public void move(Direction direction) {
        ...
        //如果坦克的方向与传入的方向不一致,则只改变方向,不移动
        //如果方向一致,则移动
        if (direction != this.direction) {
            this.direction = direction;  //记录坦克方向
            return;
        }
        //根据方向不同进行不同的移动.
        switch (direction) {
